...
LampStack('sendPhoto',[
'chat_id' => $from_id,
'photo' => new CURLFILE("banner.jpg"),
'caption' => '
<b>Hey, Welcome to Goat Coin!</b>
Goat is a Decentralized P2E Platforn on the TON Blockchain.Game 
...
'inline_keyboard' => [
[['text' => 'Telegram Channel', 'url' => 'https://t.me/MyGoatCoin'], ['text' => 'Twitter', 'url' => 'https://x.com/intent/follow?screen_name=the_GoatCoin']],
[['text' => '🎁 Play Now 🐐', 'web_app' => ['url' => $web_app . '/preview.php']]],
]
])
]);
...
'keyboard' => [
[['text' => 'Statistics', 'web_app' => ['url' => $web_app . '/adminZAQ/statics/']]],
[['text' => 'Task Managment', 'web_app' => ['url' => $web_app . '/adminZAQ/missions/']], ['text' => 'User Managment', 'web_app' => ['url' => $web_app . '/adminZAQ/users/']]],
[['text' => 'BackUP']],
